...
Se estiver usando o [sombreador standard do kit de ferramentas do reality](https://docs.microsoft.com/windows/mixed-reality/mrtk-unity/features/rendering/mrtk-standard-shader), para renderizar a profundidade para objetos transparentes:
