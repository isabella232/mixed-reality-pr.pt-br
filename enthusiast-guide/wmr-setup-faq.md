...
Se você estiver usando uma conexão Wi-Fi de 2,4 GHz, os controladores de movimento poderão retardar o Wi-Fi. Tente uma das seguintes opções:

* Alterne para uma conexão Wi-Fi de 5 GHz, se houver uma disponível. Saiba mais
