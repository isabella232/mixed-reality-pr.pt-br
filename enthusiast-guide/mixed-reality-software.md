...
A realidade mista do Windows consiste nos seguintes componentes de software principais:

1. **Portal de realidade misturada**, que fornece a principal experiência do Windows Mixed Reality
    * No Windows 10, versões 1709 e 1803, o portal da realidade mista é um componente fundamental do sistema operacional Windows 10 e é atualizado por meio de Windows Update.
...
Além disso, o uso da realidade mista do Windows no SteamVR requer o seguinte software:
...
7. O componente do **Windows Mixed Reality for SteamVR** , que une o SteamVR à realidade mista do Windows. Mais informações sobre esse componente podem ser encontradas [na página de realidade mista do Windows para SteamVR](http://store.steampowered.com/app/719950/Windows_Mixed_Reality_for_SteamVR/)

Gerenciando o headset do Windows Mixed Reality:

8. O **aplicativo do Device Companion**, desenvolvido e mantido por cada um dos fabricantes de headset, fornece uma rápida introdução ao seu headset de realidade mista do Windows. Em fones de ouvido com a funcionalidade interna do Bluetooth, o aplicativo do Device Companion permite restaurar controladores de movimento para seu emparelhamento Bluetooth de fábrica. Alguns headsets (como o Samsung Odyssey e o Samsung Odyssey +) também usam o aplicativo do Device Companion para fornecer atualizações de firmware de headset do fabricante do headset. Esse aplicativo é baixado automaticamente na primeira vez em que o headset está conectado e pode ser encontrado no menu Iniciar do Windows.
...
* Reduz distorções e Aberrations em HMD (exibições montadas à frente de realidade mista) do Windows. 
* Adiciona suporte para futuros controladores de movimento do HP Windows Mixed Reality. 
* Altera o comportamento da configuração de taxa de atualização 90Hz no Windows Mixed Reality para não voltar mais automaticamente para 60 em determinados casos quando 90Hz não puder ser obtido. 
...
#### <a name="windows-10-version-1903-may-2019-update"></a>Windows 10, versão 1903 (atualização de maio de 2019) ####
   ...
   | [10.0.18362.1062](https://www.microsoft.com/en-us/download/details.aspx?id=58492)  | 24 de junho, 2019      | Compatível com o Windows 10, versão 1809 e mais recente.<br/><ul><li>Plataforma de headset do Windows Mixed Realm fone de ouvido e melhorias de confiabilidade em computadores de suspensão e transições de estado de energia.</li></ul>  | 
   | [10.0.18362.1024](https://www.microsoft.com/en-us/download/details.aspx?id=58225)  | 1º de maio de 2019      | Compatível com o Windows 10, versão 1809 e mais recente.<br/><ul><li>Contém atualização de firmware para 2017 Acer, Asus, Dell, Fujitsu, HP, Lenovo e Medion de headsets de realidade mista do Windows. Essa atualização de firmware melhora a compatibilidade e a confiabilidade da tela com determinados adaptadores gráficos e/ou drivers gráficos.</li><li>Melhorias de confiabilidade e plataforma do Windows Mixed Reality Headset</li></ul>  | 
...
#### <a name="windows-10-version-1709-fall-creators-update"></a>Windows 10, versão 1709 (atualização para criadores de outono) ####
   ...
   | [10.0.16299.1042](https://www.microsoft.com/en-us/download/details.aspx?id=56265)  | 21 de novembro, 2017   | <ul><li>Resolve um problema que levou às telas de fone de ouvido às vezes em preto durante o uso</li><li>Resolve um problema que às vezes levou à desapareceção dos controladores de movimento</li><li>Melhorias de desempenho do sensor de presença para o headset do Dell visor</li><li>Várias correções de estabilidade e confiabilidade</li></ul> |
...
#### <a name="windows-10-version-1803-april-2018-update-and-version-1809-october-2018-update"></a>Windows 10, versão 1803 (atualização de abril de 2018) e versão 1809 (atualização de outubro de 2018) ####
   ...
   | Versão          | Data de lançamento          | Principais alterações                                                 |
   |------------------|-----------------------|---------------------------------------------------------------|
   | [10.0.17737.1000](https://www.microsoft.com/en-us/download/details.aspx?id=57359)  | 1º de outubro, 2018      | Lançamento público inicial do driver para Windows 10, versão 1809. Compatível com o Windows 10, versão 1803 e mais recente.  |
...
#### <a name="windows-10-version-1809-and-newer"></a>Windows 10, versão 1809 e mais recente ####
   ...
   | 2000.20041.1212.0  | 11 de maio de 2020          | <ul><li>Resolve um problema de tempo que estava resultando em um erro de 15-5 inconsistente.</li><li>Suporte aprimorado para executar a realidade mista do Windows sem conexão com a Internet.</li><li>Suporte aprimorado para controladores de movimento de emparelhamento por meio da **configuração de controladores**.</li></ul>  | 
   ...
   | 2000.19081.1301.0  | 23 de setembro de 2019    | <ul><li>Aborda um problema em que os fones de ouvido encontrando problemas de hardware foram mostrados uma mensagem de erro incorreta. Os usuários que receberam um código de erro 1-4 em versões anteriores podem agora receber um código de erro mais específico para o estado do dispositivo.</li></ul>  |
...
### <a name="windows-mixed-reality-for-steamvr-release-history"></a>Histórico de versões do Windows Mixed Reality for SteamVR ###

Nossas notas de versão para o componente de realidade mista do Windows para SteamVR podem ser encontradas aqui: [http://steamcommunity.com/games/719950/announcements/](http://steamcommunity.com/games/719950/announcements/)
