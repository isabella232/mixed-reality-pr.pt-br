...
* Verifique o desempenho e a estabilidade do seu PC:
    ...
    * Verifique os logs de "aplicativo" e "sistema" em **Visualizador de Eventos > logs do Windows** para ver se um aplicativo está falhando e gerando relatórios de relatório de erros do Windows (WER).
